...
for autor in autores:
    data.write(f"INSERT INTO Articulo_has_Autor (Articulo_idArticulo, Autor_idAutor) VALUES ('{autores[autor]}', '{autor}');\n")
...
enfermedades = ["GRCh37/hg19 10q11.21-26.3(chr10:42347406-135534747)x1",
                ...
                "NC_000019.10:g.(?7112255)(7249328_?)del",
...
def generate_table_articulo(n):
    for i in range(n):
        ...
        data.write(f"INSERT INTO Articulo (idArticulo, Nombre, Fecha, Enfermedad_idEnfermedad) VALUES ('{i}', '{nombre}', '{fecha}', '{enfermedad_id}');\n")
